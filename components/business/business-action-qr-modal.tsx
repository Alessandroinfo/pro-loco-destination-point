      ...
      {isOpen ? (
        ...
        >
          ...
          >
            ...
            <p className="text-sm uppercase tracking-[0.3em] text-navy-900/55">{eyebrow}</p>
            ...
            {previewLabel && previewValue ? (
              <p className="mt-5 text-sm text-navy-900/55">
                <span className="font-semibold text-navy-950">{previewLabel}</span> {previewValue}
              </p>
            ) : null}
            ...
            {actionHref && actionHrefLabel ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center justify-center rounded-full bg-navy-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-navy-900"
              >
                {actionHrefLabel}
              </a>
            ) : null}
