...
export async function generateMetadata({
  ...
  return createBusinessPageMetadata(categoryId, pageData.business, "totem", "it");
}

export default async function TotemBusinessPage({
  params
}: {
  params: Promise<{ categoryId: string; businessId: string }>;
}) {
  ...
  return <BusinessRouteView business={pageData.business} category={pageData.category} includeStructuredData={false} locale="it" />;
}
