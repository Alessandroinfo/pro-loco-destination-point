...
export async function generateMetadata({
  ...
  return createBusinessPageMetadata(categoryId, pageData.business, "standard", "en");
}

export default async function EnglishBusinessPage({
  params
}: {
  params: Promise<{ categoryId: string; businessId: string }>;
}) {
  ...
  return <BusinessRouteView business={pageData.business} category={pageData.category} locale="en" />;
}
