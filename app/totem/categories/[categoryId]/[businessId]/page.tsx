...
export async function generateMetadata({
  ...
  return createBusinessPageMetadata(categoryId, pageData.business, "totem");
}
...
export default async function TotemBusinessPage({
  ...
  return <BusinessRouteView business={pageData.business} category={pageData.category} includeStructuredData={false} />;
}
